...
/**
 * Qualcomm RIL for Samsung MSM8952 Dual Sim Devices
 * {@hide}
 */
public class SamsungMSM8952RIL extends RIL {

    private static final int RIL_REQUEST_DIAL_EMERGENCY = 10001;
    private static final int RIL_UNSOL_ON_SS_LL = 11055;

    public SamsungMSM8952RIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
        mQANElements = 6;
    }

    public SamsungMSM8952RIL(Context context, int preferredNetworkType,
